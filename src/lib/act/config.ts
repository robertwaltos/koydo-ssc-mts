// Auto-generated shim — re-exports from @/lib/ssc-mts/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _ssc_mts_Config } from "@/lib/ssc-mts/config";
import { EXAM_CONFIG as _raw } from "@/lib/ssc-mts/config";
