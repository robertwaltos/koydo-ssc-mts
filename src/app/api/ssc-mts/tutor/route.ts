...
const EXAM_ID = "ssc-mts";
const EXAM_DISPLAY_NAME = "SSC MTS (Multi-Tasking Staff)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Numerical & Mathematical Ability, Reasoning Ability, General Awareness, and English Language. Align to SSC MTS Session 1 and Session 2 syllabus.
