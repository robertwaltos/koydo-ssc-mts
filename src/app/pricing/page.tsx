...
export const metadata: Metadata = {
  title: "Pricing — Ssc Mts Premium",
  description: "Unlock unlimited Ssc Mts practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=ssc-mts&cadence=annual`;
